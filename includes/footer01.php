   ...
   <div class="container">
     <div class="row mb-5">
       <div class="col-md">
         <div class="ftco-footer-widget mb-4">
           <h2 class="ftco-heading-2 logo">Peluquería y Estética Laura</h2>
           <?php
            $ret = mysqli_query($con, "select * from tblpage where PageType='aboutus' ");
            $cnt = 1;
            while ($row = mysqli_fetch_array($ret)) {
            ?>
             <p><?php echo substr($row['PageDescription'], 0, 250); ?>
       ...
       <div class="col-md" style="padding-left: 150px">
         <div class="ftco-footer-widget mb-4">
           ...
           <ul class="list-unstyled">
             ...
             <li><a href="about.php" class="py-2 d-block">Historia</a></li>
             <li><a href="services.php" class="py-2 d-block">Servicios</a></li>

             <!-- <li><a href="admin/index.php" class="py-2 d-block">Panel Administración</a></li> -->
             ...
             <?php
              ...
              ?>
               <ul>
                 ...
                 <li>
                   <a href="#"><span class="icon icon-phone">
                     </span><span class="text">+<?php echo $row['MobileNumber']; ?></span>
                   </a>
                 </li>
                 <li>
     ...
     <div class="row">
       <div class="col-md-12 text-center">
         <p>2022 &copy; S. Rebeca Téllez Castañeda </p>
       </div>
     </div>
   </div>
 </footer>