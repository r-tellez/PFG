...
if (isset($_POST['submit'])) {
    ...
    if ($query) {
        ...
        $msg = "Upss. Algo salió mal. Inténtalo de nuevo";
    }
}
?>
<!DOCTYPE html>
            ...
            <div class="slider-item js-fullheight">
                ...
                <div class="container-fluid p-0">
                    <div class="row d-md-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
                        <img class="one-third align-self-end order-md-last img-fluid" src="images/bg_3.png" alt="">
                        <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
                            <div class="text mt-5">
                                <span class="subheading">PELUQUERIA</span>
                                <h1 class="mb-4">#ESTILONATURAL</h1>
                                <p class="mb-4">Ya sea un cambio de look, dar color o mantener tu cabello sano, Laura
                                    Peluquería y Estética es el lugar perfecto.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="slider-item js-fullheight">
                ...
                <div class="container-fluid p-0">
                    <div class="row d-flex no-gutters slider-text align-items-center justify-content-end" data-scrollax-parent="true">
                        <img class="one-third align-self-end order-md-last img-fluid" src="images/bg_5.png" alt="">
                        <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
                            <div class="text mt-5">
                                <span class="subheading">#BELLEZANATURAL</span>
                                <h1 class="mb-4">ESTÉTICA</h1>
                                <p class="mb-4">Eres perfecta, por eso te cuidamos con los mejores tratamientos y
    ...
    <section class="ftco-section ftco-no-pt ftco-booking">
        <div class="container-fluid px-0">
            <div class="row no-gutters d-md-flex justify-content-end">
                ...
                <div class="one-third">
                    <div class="img" style="background-image: url(images/colo_fashion.jpg);">
                    </div>
                </div>
            </div>
        </div>
