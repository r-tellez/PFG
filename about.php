...
<body>
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/bg15.jpg');"
        data-stellar-background-ratio="0.5">
        <div class="overlay"></div>
        <div class="container">
            <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
                <!-- <div class="col-md-9 ftco-animate pb-5">
                    <h2 class="mb-0 bread">Historia</h2>
                    <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Inicio <i
                                    class="ion-ios-arrow-forward"></i></a></span> <span>Historia<i
            ...
            <div class="row">
                <div class="col-md-6 d-flex">
                    <div class="p-md-5 img img-2 d-flex justify-content-center align-items-center"
                        style="background-image: url(images/historia.jpg);">
