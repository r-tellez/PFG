	...
	<body class="cbp-spmenu-push">
		<div class="main-content">
			...
			<div id="page-wrapper">
				<div class="main-page">
					<div class="tables">
						<h3 class="title1">Informes de ventas</h3>
						...
						<div class="table-responsive bs-example widget-shadow">
							...
							<?php if ($rtype == 'mtwise') {
								...
								$y2 = date("Y", $month2);
							?>
								<h4 class="header-title m-t-0 m-b-30">Informe de ventas mes a mes</h4>
								<!-- <h4 align="center" style="color:blue">Informe de ventas desde <?php echo $m1 . "-" . $y1; ?> hasta <?php echo $m2 . "-" . $y2; ?></h4> -->
								<hr />
								...
								<table class="table table-bordered">
									...
									?>
										<tr>
											<td><?php 
											echo $row['lmonth'] . "-" . $row['lyear']; ?></td>
											<td style="text-align:right"><?php echo $total = $row['totalprice']; ?>€</td>
									...
									<tr>
										<td colspan=2 style="text-align:right"><b>Total: <?php echo $ftotal; ?>€<b/></td>
									</tr>
								</table>
							<?php } else {
								...
								$y2 = date("Y", $year2);
							?>
								<h4 class="header-title m-t-0 m-b-30">Informe de ventas por año</h4>
								<!-- <h4 align="center" style="color:blue">Informe de ventas desde <?php echo $y1; ?> hasta <?php echo $y2; ?></h4> -->
								<hr/>
								<table class="table table-bordered">
									<thead>
											<th >Año</th>
