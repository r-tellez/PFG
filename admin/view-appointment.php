  ...
  <body class="cbp-spmenu-push">
    <div class="main-content">
      ...
      <div id="page-wrapper">
        <div class="main-page">
          <div class="tables">
            <h3 class="title1">Datos de Cita</h3>
            ...
            <div class="table-responsive bs-example widget-shadow">
              ...
              ?>
                <h4>Cita para: <?php echo $row['Name']; ?></h4>
                <table class="table ">
                  <tr>
                    <th>Nº Cita</th>
                ...
                <table class="table table-bordered">
                  ...
                  <tr>
                    ...
                    <td><?php
                        $remark = date_create($row['RemarkDate']);
                        echo date_format($remark, 'd-m-Y H:i'); ?></td>
                  </tr>
