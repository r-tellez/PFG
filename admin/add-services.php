	...
	<body class="cbp-spmenu-push">
		<div class="main-content">
			...
			<div id="page-wrapper">
				<div class="main-page">
					<div class="forms">
						<h3 class="title1">Añadir Servicios</h3>
							...
							<div class="form-body">
								<form method="post">
									...
									<div class="form-group"> 
										...
										<input type="text" id="cost" name="cost" class="form-control" placeholder="Importe" value="" required="true"> 
									</div>

									<button type="submit" name="submit" class="btn btn-default">Añadir Servicio</button>
								</form>
							</div>
