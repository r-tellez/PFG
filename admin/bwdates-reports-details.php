...
?>
	...
	<head>
		<title>Facturas por fechas</title>
	...
	<body class="cbp-spmenu-push">
		<div class="main-content">
			...
			<div id="page-wrapper">
				<div class="main-page">
					<div class="tables">
						<h3 class="title1">Facturas por fechas</h3>
						<div class="table-responsive bs-example widget-shadow">
							...
							?>
							<!-- <h3 align="center" style="color:blue">Facturas desde <?php echo $fdate ?> hasta <?php echo $tdate ?></h3> -->
							<br>
